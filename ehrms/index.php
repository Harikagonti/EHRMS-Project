...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login_button'])) {
      ...
      $mypassword = test_input($_POST["mypassword"]);
        ...
        if (mysqli_num_rows($result) === 1) {
            ...
            $role_code=$row['election_role_code'];
            $_SESSION["name"] = $row['name'];
            if($role_code=='8' OR $role_code=='9' OR $role_code=='10' OR $role_code=='11' OR $role_code=='12'){
...
<h1 class="div-class"><br>Login</h1>
...
Mobile No.<span class="mandatory">*</span>&nbsp;:<input autocomplete="off" type="text" name="mymobile" id="mymobile"><br><br>
Password<span class="mandatory">*</span>&nbsp;&nbsp;&nbsp;&nbsp;:<input autocomplete="off" type="password" name="mypassword" id="mypassword"><br><br>
<?php
if($login_error=="true")
{
