...
<h1 class="div-class">View Employee Department Details</h1><br>
<table class="centered-table">
<tr><th>Department Id</th><th>Department Code</th><th>Department Name</th></tr>
<?php
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo "<tr><td>".$row['dept_id']."</td><td>".$row['dept_code']."</td><td>".$row['dept_name']."</td></tr>";
  $i++;
  }
