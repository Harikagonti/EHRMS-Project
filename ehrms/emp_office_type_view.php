...
<br>
<h1 class="div-class" style="color:blue">View Employee Office Type Details</h1><br>
<table class="centered-table">
<tr><th>Office Type Id</th><th>Office Type Code</th><th>Office Type Name</th></tr>
<?php
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo "<tr><td>".$row['office_type_id']."</td><td>".$row['office_type_code']."</td><td>".$row['office_type_name']."</td></tr>";
  $i++;
  }
